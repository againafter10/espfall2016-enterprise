    ...
    private  String addSubCategory (String SubCategoryName, String categoryName){
        ...
        if (SubCategoryName.equals("")){
            ...
            try {
                ...
                String sqlInsertCompany ="INSERT INTO  `my store`.`sub-category` (`subcategory_id` ,`sub-category_name` ,`category_name`)VALUES (NULL ,  '"+SubCategoryName+"',  '"+categoryName+"');"; 
               // "INSERT INTO  `my store`.`product-company` (`company-id` ,`company-name`)VALUES (NULL ,  '"+companyName+"');";                
                //String sqlInsertProduct = "INSERT INTO  `my store`.`category` (`category_id` ,`category_name`)VALUES (NULL ,  '"+companyName+"'); ";
